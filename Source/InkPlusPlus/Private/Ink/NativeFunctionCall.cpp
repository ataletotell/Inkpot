...
TSharedPtr<Ink::FValue> Ink::FNativeFunctionCall::CallBinaryListOperation(const TArray<TSharedPtr<Ink::FObject>> &InParameters)
{
	...
	{
		TArray<TSharedPtr<Ink::FValue>> list;
		list.Add(value1);
		list.Add(value2);
...
void Ink::FNativeFunctionCall::GenerateNativeFunctionsIfNecessary()
{
	...
	// Int operations
	AddIntBinaryOp(Add, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() + InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Subtract, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() - InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Multiply, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() * InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Divide, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() / InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Mod, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() % InRight.GetSubtype<int32>()); });
	AddIntUnaryOp(Negate, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return FNativeFunctionOp(-(InValue.GetSubtype<int32>())); });

	AddIntBinaryOp(Equal, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() == InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Greater, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() > InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(Less, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() < InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(GreaterThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() >= InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(LessThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() <= InRight.GetSubtype<int32>()); });
	AddIntBinaryOp(NotEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InLeft.GetSubtype<int32>() != InRight.GetSubtype<int32>()); });
	AddIntUnaryOp(Not, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return FNativeFunctionOp(InValue.GetSubtype<int32>() == 0); });

	AddIntBinaryOp(And, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp((InLeft.GetSubtype<int32>() != 0) && (InRight.GetSubtype<int32>() != 0)); });
	AddIntBinaryOp(Or, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp((InLeft.GetSubtype<int32>() != 0) || (InRight.GetSubtype<int32>() != 0)); });

	AddIntBinaryOp(Max, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(FMath::Max<int32>(InLeft.GetSubtype<int32>(), InRight.GetSubtype<int32>())); });
	AddIntBinaryOp(Min, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(FMath::Min<int32>(InLeft.GetSubtype<int32>(), InRight.GetSubtype<int32>())); });
	AddIntBinaryOp(Pow, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
				   { return FNativeFunctionOp(FMath::Pow((float)InLeft.GetSubtype<int32>(), (float)InRight.GetSubtype<int32>())); });
	AddIntUnaryOp(Floor, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return InValue; });
	AddIntUnaryOp(Ceiling, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return InValue; });
	AddIntUnaryOp(Int, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return InValue; });
	AddIntUnaryOp(Float, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				  { return FNativeFunctionOp(static_cast<float>(InValue.GetSubtype<int32>())); });

	// Float Operations
	AddFloatBinaryOp(Add, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() + InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Subtract, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() - InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Multiply, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() * InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Divide, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() / InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Mod, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(-1); }); // Undefined behaviour float % float
	AddFloatUnaryOp(Negate, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return FNativeFunctionOp(-(InValue.GetSubtype<float>())); });

	AddFloatBinaryOp(Equal, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() == InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Greater, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() > InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(Less, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() < InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(GreaterThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() >= InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(LessThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() <= InRight.GetSubtype<float>()); });
	AddFloatBinaryOp(NotEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(InLeft.GetSubtype<float>() != InRight.GetSubtype<float>()); });
	AddFloatUnaryOp(Not, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InValue.GetSubtype<float>() == 0.f); });

	AddFloatBinaryOp(And, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp((InLeft.GetSubtype<float>() != 0.f) && (InRight.GetSubtype<float>() != 0.f)); });
	AddFloatBinaryOp(Or, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp((InLeft.GetSubtype<float>() != 0.f) || (InRight.GetSubtype<float>() != 0.f)); });

	AddFloatBinaryOp(Max, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(FMath::Max<float>(InLeft.GetSubtype<float>(), InRight.GetSubtype<float>())); });
	AddFloatBinaryOp(Min, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(FMath::Min<float>(InLeft.GetSubtype<float>(), InRight.GetSubtype<float>())); });
	AddFloatBinaryOp(Pow, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					 { return FNativeFunctionOp(FMath::Pow(InLeft.GetSubtype<float>(), InRight.GetSubtype<float>())); });
	AddFloatUnaryOp(Floor, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return FNativeFunctionOp(FMath::Floor(InValue.GetSubtype<float>())); });
	AddFloatUnaryOp(Ceiling, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return FNativeFunctionOp(FMath::CeilToFloat(InValue.GetSubtype<float>())); });
	AddFloatUnaryOp(Int, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return FNativeFunctionOp(static_cast<int32>(InValue.GetSubtype<float>())); });
	AddFloatUnaryOp(Float, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
					{ return InValue; });

	// String Operations
	AddStringBinaryOp(Add, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					  { return FNativeFunctionOp(InLeft.GetSubtype<FString>() + InRight.GetSubtype<FString>()); });
	AddStringBinaryOp(Equal, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					  { return FNativeFunctionOp(InLeft.GetSubtype<FString>().Equals(InRight.GetSubtype<FString>())); });
	AddStringBinaryOp(NotEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					  { return FNativeFunctionOp(!(InLeft.GetSubtype<FString>().Equals(InRight.GetSubtype<FString>()))); });
	AddStringBinaryOp(Has, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					  { return FNativeFunctionOp(InRight.GetSubtype<FString>().IsEmpty() || InLeft.GetSubtype<FString>().Contains(InRight.GetSubtype<FString>())); });
	AddStringBinaryOp(Hasnt, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					  { return FNativeFunctionOp(!(InLeft.GetSubtype<FString>().Contains(InRight.GetSubtype<FString>()))); });

	// List Operations
	AddListBinaryOp(Add, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().Union(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(Subtract, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().Without(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(Has, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().ContainsList(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(Hasnt, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(!(InLeft.GetSubtype<Ink::FInkList>().ContainsList(InRight.GetSubtype<Ink::FInkList>()))); });
	AddListBinaryOp(Intersect, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().Intersect(InRight.GetSubtype<Ink::FInkList>())); });

	AddListBinaryOp(Equal, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().Equals(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(Greater, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().GreaterThan(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(Less, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().LessThan(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(GreaterThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().GreaterThanOrEquals(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(LessThanOrEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(InLeft.GetSubtype<Ink::FInkList>().LessThanOrEquals(InRight.GetSubtype<Ink::FInkList>())); });
	AddListBinaryOp(NotEquals, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp(!(InLeft.GetSubtype<Ink::FInkList>().Equals(InRight.GetSubtype<Ink::FInkList>()))); });

	AddListBinaryOp(And, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp((InLeft.GetSubtype<Ink::FInkList>().Num() > 0) && (InRight.GetSubtype<Ink::FInkList>().Num() > 0)); });
	AddListBinaryOp(Or, [](FNativeFunctionOp InLeft, FNativeFunctionOp InRight) -> FNativeFunctionOp
					{ return FNativeFunctionOp((InLeft.GetSubtype<Ink::FInkList>().Num() > 0) || (InRight.GetSubtype<Ink::FInkList>().Num() > 0)); });
	AddListUnaryOp(Not, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().Num() == 0 ? 1 : 0); });
	...
	AddListUnaryOp(Invert, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().Inverse()); });
	AddListUnaryOp(All, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().All()); });
	AddListUnaryOp(ListMin, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().MinAsList()); });
	AddListUnaryOp(ListMax, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().MaxAsList()); });
	AddListUnaryOp(Count, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().Num()); });
	AddListUnaryOp(ValueOfList, [](FNativeFunctionOp InValue) -> FNativeFunctionOp
				   { return FNativeFunctionOp(InValue.GetSubtype<Ink::FInkList>().MaxItem().Value); });
